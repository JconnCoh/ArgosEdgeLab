...
param(
    ...
    [switch]$JunctionGate,
    [string]$PayloadRoot = '',
    [string]$WorkRoot = 'D:\A2\w\ocv\R18ZV3',
    [string]$OutputRoot = 'D:\A2\o\ocv\R18ZV3',
...
$packageRevision = 'R18ZV3_EXISTING_ORIENTED_CROPS_FIXED_PARALLEL_20260911A'
...
$payloadManifestSha = '8911730643BD973430F7B6DE806DE3D146AD4468F9824C7353FC3AC50CCCA681'
$configurationSha = '6DFF191C6755A93C84C766E05DBEA9DC7E457B5A309119E0F97A341D23DD673F'
...
$installedLauncher = 'C:\ProgramData\ArgosEdgeLabRO\AllWaferProcessorV2\OCV02_R18ZV3.ps1'
$configuredWorkRoot = 'D:\A2\w\ocv\R18ZV3'
$configuredOutputRoot = 'D:\A2\o\ocv\R18ZV3'
$configuredCanonicalProposalRoot = 'C:\ProgramData\ArgosEdgeLabRO\AllWaferProcessorV2\identity\proposals'
$configuredProposalAlias = 'D:\A2\w\ocv\R18ZV3\p'
$configuredProviderPath = 'D:\A2\w\ocv\R18ZV3\OPENCV_SCRIBE_R18ZV1\ArgosOpenCvScribeV1R18ZV1BatchAdapter.py'
$configuredR11AnalyzerPath = 'D:\A2\w\ocv\R18ZV3\OPENCV_SCRIBE_R11A\ArgosOpenCvScribeV1R11.py'
...
function Invoke-R18ZTProposalJunctionGate {
    ...
    try {
        ...
        Write-JsonNew $invalidConfiguration ([ordered]@{batchId='R18ZV3';proposalRoot=$invalidAlias;canonicalProposalRoot=$invalidCanonical}) 4
        ...
        foreach ($directory in @($sleepFailed,$sleepWork,$sleepOutput,$sleepCanonical,$sleepRoot,$fastWork,$fastOutput,$fastCanonical,$fastRoot,$invalidFailed,$invalidWork,$invalidOutput,$invalidCanonical,$invalidRoot,$collisionRoot,$junctionGateRoot)) {
    ...
    [ordered]@{
        schema = 'argos_opencv_scribe_r18zv3_parallel_resource_gate_v1'
        checkedUtc = [DateTime]::UtcNow.ToString('o')
        state = 'PASS_R18ZV3_PARALLEL_ENVELOPE_RESOURCE_PRESERVATION_GATE'
...
Require ([string]$configuration.schema -eq 'argos_opencv_scribe_r18zt_batch_configuration_v2' -and [string]$configuration.batchId -eq 'R18ZV3' -and [string]$configuration.revision -eq $runnerRevision) 'R18ZT configuration contract changed.'
