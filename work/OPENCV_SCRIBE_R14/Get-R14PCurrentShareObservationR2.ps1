...
$expectedInvocationLeaf = 'Get-R14PCurrentShareObservationR2.invocation.json'
...
Assert-True ([string]$invocation.schema -ceq 'argos_r14p_current_share_observation_invocation_v2') 'R14P R2 invocation schema changed.'
Assert-True ([string]$invocation.responseScanScope -ceq 'POST_PROVEN_ZERO_UNRESOLVED_BOUNDARY_ONLY') 'R14P R2 response scan scope changed.'
Assert-True ([string]$invocation.responseCorrelationMode -ceq 'SIGNED_EXACT_REQUEST_ID') 'R14P R2 response correlation mode changed.'
