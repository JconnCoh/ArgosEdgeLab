...
$expectedInvocationLeaf = 'Get-R13BCurrentShareObservation.invocation.json'
...
Assert-True ([string]$invocation.schema -ceq 'argos_r13b_current_share_observation_invocation_v1') 'R13B invocation schema changed.'
