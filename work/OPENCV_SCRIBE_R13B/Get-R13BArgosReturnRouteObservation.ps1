...
if ($Preflight) {
    [ordered]@{
        schema = 'argos_r13b_argos_return_route_observation_preflight_v1'
        state = 'PASS_R13B_ARGOS_RETURN_ROUTE_OBSERVATION_PREFLIGHT'
...
$result = [ordered]@{
    schema = 'argos_r13b_argos_return_route_observation_v1'
    createdUtc = [DateTime]::UtcNow.ToString('o')
    state = if ($healthy) {'PASS_R13B_ARGOS_RETURN_ROUTE_READ_ONLY_OBSERVATION'} else {'HOLD_R13B_ARGOS_RETURN_ROUTE_READ_ONLY_OBSERVATION'}
