...
$packageRevision = 'R18ZT_EXISTING_ORIENTED_CROPS_ASYNC_REVIEW_ONLY_20260906B'
$runnerRevision = 'R18ZT_EXISTING_ORIENTED_CROPS_PUBLIC_PROVIDER_BATCH_20260906C'
$envelopeRevision = 'R18ZT_EXISTING_ORIENTED_CROPS_ASYNC_REVIEW_ONLY_20260906B'
$payloadManifestSha = 'C3A6153AA298D40F6D9808BAB2A5BD2105547C603AE9F6FFF0C01167754074EB'
$configurationSha = '35AA8D910AEB2A3DD68BB8FF06D396FD2E4F9702660DAEA067A1DDC242F2918C'
$envelopeSha = '29271D74CF9225BC0E5B0AA3ED459864B5F49E3BF852B4294FB5743F95DF86E2'
$delegateSha = 'B830F642C4308F542E9D662F93193714EC54933B47999750C0521E62A827A30C'
...
$configuredProposalAlias = 'D:\A2\w\ocv\R18ZT1\p'
$configuredProviderPath = 'D:\A2\w\ocv\R18ZT1\OPENCV_SCRIBE_R18ZT\ArgosOpenCvScribeV1R18ZT.py'
$configuredR11AnalyzerPath = 'D:\A2\w\ocv\R18ZT1\OPENCV_SCRIBE_R11A\ArgosOpenCvScribeV1R11.py'
...
function Get-R18ZTExactCompleteValidation([string]$OutputRoot, [string]$ConfigurationPath) {
    ...
    try {
        ...
        foreach ($pair in @(
            ...
            [pscustomobject]@{field='revision';value='R18ZT_EXISTING_ORIENTED_CROPS_PUBLIC_PROVIDER_BATCH_20260906C'}
        )) {
...
if ($JunctionGate) {
    $junctionGateRoot = 'C:\R18ZT1JG'
    Require (-not (Test-Path -LiteralPath $junctionGateRoot)) "R18ZT fresh junction-gate root exists: $junctionGateRoot"
    Require (Test-Path -LiteralPath $PythonPath -PathType Leaf) 'R18ZT junction gate Python runtime is absent.'
    Require ((Get-Sha256 $PythonPath) -eq $ExpectedPythonSha256) 'R18ZT junction gate Python runtime changed.'
    ...
    try {
        ...
        $sleepStartInfo.FileName = $PythonPath
        ...
        $fastStartInfo.FileName = $PythonPath
        ...
        $invalidStartInfo.FileName = $PythonPath
        ...
        Write-JsonNew $invalidConfiguration ([ordered]@{batchId='R18ZT1';proposalRoot=$invalidAlias;canonicalProposalRoot=$invalidCanonical}) 4
    ...
    [ordered]@{
        ...
        launcherSha256 = Get-Sha256 ([IO.Path]::GetFullPath($MyInvocation.MyCommand.Path))
...
Require ([string]$configuration.schema -eq 'argos_opencv_scribe_r18zt_batch_configuration_v2' -and [string]$configuration.batchId -eq 'R18ZT1' -and [string]$configuration.revision -eq $runnerRevision) 'R18ZT configuration contract changed.'
