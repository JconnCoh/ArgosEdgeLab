...
function Invoke-StatusHandler {
    ...
    if($null-ne$metadataRequest-and[bool](Get-MemberValue $metadataRequest 'enabled' $false)){
        $providerPath=[IO.Path]::GetFullPath('C:\ProgramData\ArgosEdgeLabRO\AllWaferProcessorV2\OCV03_MetadataProviderV1.ps1')
        ...
        $aliasName='F';$maximumDepth=8;$maximumEntries=20000;$maximumDirectories=2048;$maximumBmpLeaves=2048;$timeoutSeconds=120
