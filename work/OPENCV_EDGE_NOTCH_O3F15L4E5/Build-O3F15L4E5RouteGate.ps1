...
$outputPath=Join-Path $PSScriptRoot 'final_o3f15l4e5\O3F15L4E5_PREPUBLICATION_PATH_R4_GATE.json'
...
Need ([string]$sign.state-eq'PASS_O3F15L4E5_SIGNED_EXACT_978_FRONT_LAUNCH_PACKAGE') 'E4 sign gate changed.'
$oldId=[string]$old.requestId
$newId=[string]$sign.requestId
$rows=New-Object Collections.Generic.List[object]
foreach($row in @($old.routePaths)){
  $path=([string]$row.path).Replace($oldId,$newId).Replace('O3F15L4E3','O3F15L4E5').Replace('o3f15l4e3','o3f15l4e5')
