...
function Invoke-CollectorZipLookupRehearsal([string]$ProjectRoot, [object]$Invocation, [string]$InvocationPath, [string]$CollectorPath) {
    ...
    $gate = [ordered]@{
        ...
        collectorPath='work/OPENCV_SCRIBE_R14/Collect-R15EResponse.ps1';collectorSha256=Get-Sha256 $CollectorPath;rehearsalInvocationPath='work/OPENCV_SCRIBE_R14/Test-R15ECollector.invocation.json';rehearsalInvocationSha256=Get-Sha256 $InvocationPath
