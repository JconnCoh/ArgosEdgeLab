...
$cloneRemediationPath = Join-Path $PSScriptRoot 'R18ZT_PACKAGE_C_CLONE_REMEDIATION_V5.json'
...
$cloneRawGatePath = Join-Path $PSScriptRoot 'R18ZT_PACKAGE_C_CLONE_LITERAL_RAW_GATE_V5.json'
$cloneGatePath = Join-Path $PSScriptRoot 'R18ZT_PACKAGE_C_CLONE_GATE_V5.json'
$pathGatePath = Join-Path $PSScriptRoot 'R18ZT_PATH_PLAN_GATE_V3.json'
$powerShellGatePath = Join-Path $PSScriptRoot 'R18ZT_POWERSHELL_SAFETY_GATE_V2.json'
...
$preactionPath = Join-Path $PSScriptRoot 'PREACTION_R18ZT_SIGNED_UNPUBLISHED_PACKAGE_V2.json'
...
$expectedClonePairs = [ordered]@{
    'work/OPENCV_SCRIBE_R18ZT_BATCH_PACKAGE_C/Invoke-R18ZTBatchLaunchV3.ps1' = [string]($artifactRows | Where-Object name -eq 'launcher').sha256
    'work/OPENCV_SCRIBE_R18ZT_BATCH_PACKAGE_C/Build-R18ZTBatchRequestV3.ps1' = $builderSha
    'work/OPENCV_SCRIBE_R18ZT_BATCH_PACKAGE_C/Run-R18ZTBatchExecutionEnvelopeV2.py' = [string]($artifactRows | Where-Object name -eq 'executionEnvelope').sha256
    'work/OPENCV_SCRIBE_R18ZT_BATCH_PACKAGE_C/Test-R18ZTBatchExecutionEnvelopeV2.py' = [string]($artifactRows | Where-Object name -eq 'executionEnvelopeTest').sha256
}
...
Require ([string]$cloneGate.rawUtilityGatePath -ceq 'work/OPENCV_SCRIBE_R18ZT_BATCH_PACKAGE_C/R18ZT_PACKAGE_C_CLONE_LITERAL_RAW_GATE_V5.json' -and [string]$cloneGate.rawUtilityGateSha256 -cmatch '^[A-F0-9]{64}$') 'R18ZT raw clone utility gate pin is absent.'
...
foreach ($scriptPin in @([pscustomobject]@{path='work/OPENCV_SCRIBE_R18ZT_BATCH_PACKAGE_C/Invoke-R18ZTBatchLaunchV3.ps1';sha=[string]($artifactRows | Where-Object name -eq 'launcher').sha256}, [pscustomobject]@{path='work/OPENCV_SCRIBE_R18ZT_BATCH_PACKAGE_C/Build-R18ZTBatchRequestV3.ps1';sha=$builderSha})) {
...
$builderDependency = @($preaction.dependencies | Where-Object { [string]$_.path -eq 'work/OPENCV_SCRIBE_R18ZT_BATCH_PACKAGE_C/Build-R18ZTBatchRequestV3.ps1' })
