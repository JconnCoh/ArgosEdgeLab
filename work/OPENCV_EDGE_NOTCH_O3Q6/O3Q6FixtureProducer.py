#!/usr/bin/env python3
"""Local-only producer for exact packaged O3Q6 entrypoint rehearsal; reads no images."""
...
fixture_path = Path(__file__).resolve().parent.parent / "contracts" / "O3Q6_TERMINAL_GATE_FIXTURE.json"
