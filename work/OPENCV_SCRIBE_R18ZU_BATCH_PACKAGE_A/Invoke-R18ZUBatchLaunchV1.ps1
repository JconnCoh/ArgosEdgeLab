...
param(
    ...
    [switch]$JunctionGate,
    [string]$PayloadRoot = '',
    [string]$WorkRoot = 'D:\A2\w\ocv\R18ZU1',
    [string]$OutputRoot = 'D:\A2\o\ocv\R18ZU1',
...
$packageRevision = 'R18ZU_EXISTING_ORIENTED_CROPS_ASYNC_REVIEW_ONLY_20260908A'
...
$payloadManifestSha = 'EF9E3087E9E649C423EA4B5FAAD037629ABD6C283EE2815F5E38FB52E157D678'
$configurationSha = '81AA800CE637E6353390A40842E4FE569D7FD533C56FBAA5F1DDE66F32353C13'
...
$providerSha = '935BAAE98331FF128D4204B6C8AB2E7EBEF8A38B2773F4ACCE59AE3A78C7FF87'
$providerRevision = 'ARGOS_OPENCV_SCRIBE_V1R18ZU_CANONICAL_Z_GEOMETRY_DIAGNOSTIC_20260908'
...
$installedLauncher = 'C:\ProgramData\ArgosEdgeLabRO\AllWaferProcessorV2\OCV02_R18ZU1.ps1'
$configuredWorkRoot = 'D:\A2\w\ocv\R18ZU1'
$configuredOutputRoot = 'D:\A2\o\ocv\R18ZU1'
$configuredCanonicalProposalRoot = 'C:\ProgramData\ArgosEdgeLabRO\AllWaferProcessorV2\identity\proposals'
$configuredProposalAlias = 'D:\A2\w\ocv\R18ZU1\p'
$configuredProviderPath = 'D:\A2\w\ocv\R18ZU1\OPENCV_SCRIBE_R18ZU\ArgosOpenCvScribeV1R18ZU.py'
$configuredR11AnalyzerPath = 'D:\A2\w\ocv\R18ZU1\OPENCV_SCRIBE_R11A\ArgosOpenCvScribeV1R11.py'
...
function Invoke-R18ZTProposalJunctionGate {
    ...
    try {
        ...
        Write-JsonNew $invalidConfiguration ([ordered]@{batchId='R18ZU1';proposalRoot=$invalidAlias;canonicalProposalRoot=$invalidCanonical}) 4
...
$providerRelative = 'OPENCV_SCRIBE_R18ZU\ArgosOpenCvScribeV1R18ZU.py'
...
Require ([string]$configuration.schema -eq 'argos_opencv_scribe_r18zt_batch_configuration_v2' -and [string]$configuration.batchId -eq 'R18ZU1' -and [string]$configuration.revision -eq $runnerRevision) 'R18ZT configuration contract changed.'
