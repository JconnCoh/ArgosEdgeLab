...
if([int]$beforeState.confirmedPhysical-ne10-or[int]$beforeState.overlayPhysicalMatches-ne10-or[int]$beforeState.metadataMatchedCatalogRows-ne10){throw 'R9 expected ten confirmed, verified, and FRONT catalog acquisitions.'}
...
if([int]$afterState.confirmedPhysical-ne10-or[int]$afterState.overlayPhysicalMatches-ne10-or[int]$afterState.metadataMatchedCatalogRows-ne10-or[int]$afterState.staleMatchedInsiteRows-ne0-or[int]$afterState.scribeHoldRows-ne0-or[int]$afterState.notReadyMatchedRows-ne0){throw 'R9 downstream catalog did not admit all ten confirmed FRONT wafers.'}
