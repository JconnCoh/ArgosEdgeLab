...
param(
    [switch]$Preflight,
    [switch]$Test,
    [string]$PackageRoot = 'C:\O3F15L4D2PK'
)
...
$signGatePath = Join-Path $PSScriptRoot 'final_o3f15l4d2\O3F15L4D2_SIGN_GATE.json'
...
$gatePath = Join-Path $PSScriptRoot 'O3F15L4D2_FINAL_ZIP_REHEARSAL_GATE.json'
