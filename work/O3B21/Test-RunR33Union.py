#!/usr/bin/env python3
"""Small construction test for the create-new R33 union runner."""
...
def main() -> int:
    runner = Path(__file__).with_name("Run-R33Union.py")
    with tempfile.TemporaryDirectory(prefix="r33_union_test_") as raw_root:
        root = Path(raw_root)
        ...
        detector.write_text(
            ...
            "if n==92:pairs=[{'meanAngleDegrees':89.68278051376019,'confirmationMode':'CONTROL'}];bf={'multiPairExteriorCleanResolution':{'state':'PASS_UNIQUE_BOTH_CHANNELS_EXTERIOR_CLEAR_PAIR'}}\n"
        ...
        base[92]["expectedPairedCandidateCount"] = 1
        ...
        assert summary["state"] == "PASS_R33_UNION_301_OF_301"
    ...
    print("PASS_R33_UNION_RUNNER_CONSTRUCTION_301")
    return 0
