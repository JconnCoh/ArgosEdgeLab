#!/usr/bin/env python3
"""Construction tests for the R34 rotation/holder-ablation gate."""
...
RUNNER = Path(__file__).with_name("Diagnose-R34RotationHolderAblation.py")
spec = importlib.util.spec_from_file_location("r34rot1_gate_test", RUNNER)
if spec is None or spec.loader is None:
    raise RuntimeError("Unable to load R34ROT1 runner")
...
def main() -> int:
    ...
    assert passed["state"] == "PASS_R34ROT1_8_OF_8"
    ...
    assert held["state"] == "HOLD_R34ROT1_REGRESSION_GATE"
    expected_codes = {
    ...
    print("PASS_R34ROT1_CONSTRUCTION_2_OF_2")
    return 0
