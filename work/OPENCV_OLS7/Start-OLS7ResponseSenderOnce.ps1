...
$s='argos_ols7_response_sender_start_once_v1';$m=$false;$g='preflight'
...
$a=(($t[0].Actions|%{"$($_.Execute) $($_.Arguments)"})-join' ');if($a-notmatch'JBOD_RESPONSE_SENDER\.json'){throw'Task action changed'}
