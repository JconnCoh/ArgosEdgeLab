...
ENGINE_SHA256 = "8A6DE04B7DD08EFA717AF606FD0D04622ABE84C753B690C4590B0E95D8B31BAB"
...
def load_engine(path: Path):
    specification = importlib.util.spec_from_file_location("argos_opencv_scribe_r3_full_gate", path)
...
def main() -> int:
    ...
    if engine.sha256_file(engine_path) != ENGINE_SHA256:
        raise RuntimeError("R3 engine hash changed.")
    ...
    gate = {
        "schema": "argos_opencv_scribe_r3_full_localization_gate_v1",
        "createdUtc": datetime.now(timezone.utc).isoformat(),
        "state": "PASS_OCV02_R3_FULL_LOCALIZATION_AND_RECOGNITION_15_OF_15" if passed else "FAIL_OCV02_R3_FULL_LOCALIZATION_AND_RECOGNITION",
        "engine": {
