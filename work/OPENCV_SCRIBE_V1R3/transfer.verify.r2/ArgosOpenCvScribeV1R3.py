#!/usr/bin/env python3
"""Argos review-only OpenCV scribe provider, semantic revision R3.

R3 ports the locked SemiM12DotMatrixImageReader V6 mechanics without
...
from a path, filename, or image dimensions.
"""
...
ENGINE_REVISION = "ARGOS_OPENCV_SCRIBE_V1R3_20260825"
...
def analyze_images(
    ...
    return {
        ...
        "provenance": {
            ...
            "standardAndExceptionResultsDistinct": True,
