#!/usr/bin/env python3
"""Run locked, review-only R4 scribe recognition and semantic gates."""
...
def load_engine(path: Path):
    specification = importlib.util.spec_from_file_location("argos_opencv_scribe_r4", path)
...
def main() -> int:
    ...
    semantic_job = {
        "jobId": "R4_NEGATIVE_UNQUALIFIED_EXCEPTION_TEXTURE",
        "search": {
            "expectedRegions": [],
    ...
    auto_job = {
        "jobId": "R4_POSITIVE_REVIEW_ONLY_AUTO_LOCALIZED_DEVELOPMENT",
    ...
    auto_checks = {
        ...
        "boundedSubsetPromoted": 0 < auto_result["localization"]["autoLocalizedPromotedCandidateCount"] <= 4,
    ...
    gate = {
        ...
        "state": "PASS_OCV02_R4_LOCKED_READER_AND_SEMANTIC_PARITY" if passed else "FAIL_OCV02_R4_LOCKED_READER_AND_SEMANTIC_PARITY",
        "engine": {
