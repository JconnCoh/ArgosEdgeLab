...
$responseId = '__O2D19_RESPONSE_ID__'
$sourceZip = 'U:\ProjectPortalRO\responses\__O2D19_RESPONSE_ID__.ready.zip'
$expectedBytes = __O2D19_RESPONSE_BYTES__
$expectedSha256 = '__O2D19_RESPONSE_SHA256__'
