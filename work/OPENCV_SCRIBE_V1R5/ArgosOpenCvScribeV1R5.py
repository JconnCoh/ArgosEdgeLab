#!/usr/bin/env python3
"""Argos review-only OpenCV scribe provider, semantic revision R5.
...
candidates that meet a configured OCR-scale band-width gate. Those candidates
are expanded only to a configured OCR working envelope, remain
identity-ineligible, and always carry a dedicated automatic-localization hold.
"""
...
ENGINE_REVISION = "ARGOS_OPENCV_SCRIBE_V1R5_20260826"
...
def analyze_images(
    ...
    if auto_localized_development:
        ...
        eligible_regions = [
            region for region in diagnostic_regions
