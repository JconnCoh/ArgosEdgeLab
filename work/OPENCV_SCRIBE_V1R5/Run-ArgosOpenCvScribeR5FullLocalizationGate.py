...
ENGINE_SHA256 = "F61F5954A77E6F730A2BF0D110A468535C4595D25DB21AFFE1573EF08B8139AB"
...
def load_engine(path: Path):
    specification = importlib.util.spec_from_file_location("argos_opencv_scribe_r5_full_gate", path)
...
def main() -> int:
    ...
    if engine.sha256_file(engine_path) != ENGINE_SHA256:
        raise RuntimeError("R5 engine hash changed.")
    ...
    gate = {
        ...
        "state": "PASS_OCV02_R5_FULL_LOCALIZATION_AND_RECOGNITION_15_OF_15" if passed else "FAIL_OCV02_R5_FULL_LOCALIZATION_AND_RECOGNITION",
        "engine": {
