#!/usr/bin/env python3
"""Create a fresh, small BF/DF source-pair fixture for O3D3 endpoint rehearsal."""
...
def main() -> int:
    ...
    if output_root.exists():
        raise FileExistsError(f"O3D3 fixture root already exists: {output_root}")
    r6 = load_r6(r6_path)
    core = r6.core
    base = r6.base
    ...
    job = {
        ...
        "revision": "O3D3_ENDPOINT_REHEARSAL_FIXTURE_20260827",
        ...
        "inputs": [
            {
                "identity": "O3D3_REHEARSAL_SLOT01",
    ...
    gate = {
        "schema": "argos_o3d3_rehearsal_fixture_gate_v1",
        "state": "PASS_O3D3_REHEARSAL_FIXTURES_CREATED",
        "r6Path": str(r6_path),
