...
function Get-EnvironmentInventory {
    ...
    if($childNames.Count-lt1-or$childNames.Count-gt4){throw 'Environment inventory requires one to four volume-root child names.'}
    ...
    return [ordered]@{
        schema='argos_project_portal_environment_inventory_v1'
