...
def process(job_path: Path, output_root: Path) -> dict[str, Any]:
    ...
    manifest = {
        "schema": "argos_ocv03_wafer_topology_axis_manifest_v1", "revision": str(job["revision"]), "state": "PASS_O3L7_WAFER_TOPOLOGY_AXIS_REVIEW_RENDERED",
...
def main() -> int:
    ...
    result = {
        "schema": "argos_ocv03_wafer_topology_axis_preflight_v1", "state": "PASS_O3L7_WAFER_TOPOLOGY_AXIS_PREFLIGHT", "revision": str(job["revision"]),
