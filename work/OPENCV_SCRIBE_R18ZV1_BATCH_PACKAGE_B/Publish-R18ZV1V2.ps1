...
Require ([string]$invocation.packageBinding.expectedSchema -ceq 'argos_opencv_scribe_r18zv1_package_bindings_v1') 'Fresh R18ZV1 package binding schema declaration changed.'
