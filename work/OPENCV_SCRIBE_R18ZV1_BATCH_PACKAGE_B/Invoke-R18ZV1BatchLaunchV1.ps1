...
param(
    ...
    [switch]$JunctionGate,
    [string]$PayloadRoot = '',
    [string]$WorkRoot = 'D:\A2\w\ocv\R18ZV1',
    [string]$OutputRoot = 'D:\A2\o\ocv\R18ZV1',
...
$packageRevision = 'R18ZV1_EXISTING_ORIENTED_CROPS_ASYNC_REVIEW_ONLY_20260910B'
...
$payloadManifestSha = 'B05892C2BD7A7A911016C7F51A6BA62987B32FA8266C0D772466D09C1E376360'
$configurationSha = 'E41B4C52483A8053053399192DBAE19C021C973B87878FBFD6BD238AB616EDDB'
...
$providerSha = '81B0AAAE1CBC044321CD0CDA5F1147202F7D8CB384D7E721A36B93AE0C24E2D7'
...
$installedLauncher = 'C:\ProgramData\ArgosEdgeLabRO\AllWaferProcessorV2\OCV02_R18ZV1.ps1'
$configuredWorkRoot = 'D:\A2\w\ocv\R18ZV1'
$configuredOutputRoot = 'D:\A2\o\ocv\R18ZV1'
$configuredCanonicalProposalRoot = 'C:\ProgramData\ArgosEdgeLabRO\AllWaferProcessorV2\identity\proposals'
$configuredProposalAlias = 'D:\A2\w\ocv\R18ZV1\p'
$configuredProviderPath = 'D:\A2\w\ocv\R18ZV1\OPENCV_SCRIBE_R18ZV1\ArgosOpenCvScribeV1R18ZV1.py'
$configuredR11AnalyzerPath = 'D:\A2\w\ocv\R18ZV1\OPENCV_SCRIBE_R11A\ArgosOpenCvScribeV1R11.py'
...
function Invoke-R18ZTProposalJunctionGate {
    ...
    try {
        ...
        Write-JsonNew $invalidConfiguration ([ordered]@{batchId='R18ZV1';proposalRoot=$invalidAlias;canonicalProposalRoot=$invalidCanonical}) 4
...
$providerRelative = 'OPENCV_SCRIBE_R18ZV1\ArgosOpenCvScribeV1R18ZV1.py'
...
Require ([string]$configuration.schema -eq 'argos_opencv_scribe_r18zt_batch_configuration_v2' -and [string]$configuration.batchId -eq 'R18ZV1' -and [string]$configuration.revision -eq $runnerRevision) 'R18ZT configuration contract changed.'
