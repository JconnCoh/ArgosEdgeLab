...
MODE=os.environ.get("O3F15L4D3_FIXTURE_MODE","PASS")
...
def success(mode:str)->dict:
    return {"schema":"argos_ocv03_o3f15l4_preflight_v1","state":"PASS_O3F15L4_FRONT_RECONCILE_PREFLIGHT","runnerPath":__file__,"runnerSha256":"3C403376521B74E3A6DB1C4E008CE8DB36D8D99AE9A0FD7C1FA51481024DBEF4","focusedTestSha256":"E98A90ADCF9E705BCA0B57979167FB7F0DAFE526D24FA015EC85DEA6F184BBE0","cohortCounts":{"HOLDOUT18":18,"CURRENT_TAIL":247,"FULL_TAIL":713,"FULL978":978},"actualFrozen978LexicalClassification":classification(mode),"mutationsPerformed":False}
